...
{
    public class GasTruck : LargeCommercialMotorVehicle, IGasVehicle
    {
        public GasTruck(decimal initialFuelPercentage) : base(initialFuelPercentage)
        {
            RefuelToPercentage(initialFuelPercentage);
        }
